...
#define	A_MSC_LPM		(MSC_BASE + 0x040)
...
#define	REG_MSC_LPM		REG32(A_MSC_LPM)
...
do {						\
	REG_GPIO_PXFUNS(3) = 0x0018ffff;	\
	REG_GPIO_PXTRGC(3) = 0x0018ffff;	\
	REG_GPIO_PXSELC(3) = 0x0018ffff;	\
	REG_GPIO_PXPES(3) =  0x0018ffff;		\
} while (0)
/*
...
#define __gpio_as_msc 	__gpio_as_msc1_4bit /* default as msc0 4bit */
//#define __gpio_as_msc 	__gpio_as_msc1_4bit /* default as msc0 4bit */
