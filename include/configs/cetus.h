...
#define CFG_CPU_SPEED		432000000	/* CPU clock */
...
#define CONFIG_REVY_BOOTCOMMAND		"msc read 0x80600000 0x800000 0x300000;bootm"
#else  /* CONFIG_NAND_U_BOOT */
#define CONFIG_REVY_BOOTARGS		LINUX_CMDLINE1
#define CONFIG_REVY_BOOTCOMMAND		"nand read 0x80600000 0x800000 0x300000;bootm"
#endif
#endif
...
#define PTN_MISC_OFFSET              (3  * 0x100000)

#define PTN_ROOTFS_OFFSET            (12 * 0x100000)
#define PTN_EBOOK_OFFSET           	 (112* 0x100000)
#define PTN_QTE_OFFSET           	 (172 * 0x100000)
#define PTN_USERDATA_OFFSET          (252 * 0x100000)


#define PTN_BOOT_SIZE               ( 4 * 0x100000)
#define PTN_RECOVERY_SIZE           ( 4 * 0x100000)

#define PTN_BOOT_OFFSET                 (4 * 0x100000)
#define PTN_RECOVERY_OFFSET             (8* 0x100000)
...
#define MBR_P1_OFFSET 	PTN_ROOTFS_OFFSET
#define MBR_P1_SIZE 	PTN_ROOTFS_SIZE
#define MBR_P1_TYPE 	0x83

#define MBR_P2_OFFSET 	PTN_EBOOK_OFFSET
#define MBR_P2_SIZE 	PTN_EBOOK_SIZE
#define MBR_P2_TYPE 	0x83

#define MBR_P3_OFFSET 	PTN_QTE_OFFSET
#define MBR_P3_SIZE 	PTN_QTE_SIZE
#define MBR_P3_TYPE 	0x83

#define MBR_P4_OFFSET 	PTN_USERDATA_OFFSET
#define MBR_P4_SIZE 	PTN_USERDATA_SIZE
#define MBR_P4_TYPE 	0x0B
...
#define CFG_NAND_U_BOOT_SIZE	(512 << 12)	/* support 24bit bmp Size of RAM U-Boot image	*/
...
//#define CFG_MSC_U_BOOT_SIZE	(800 << 12)	/* Size of RAM U-Boot image	*/
#define CFG_MSC_U_BOOT_SIZE	(1000 << 11)	/* Size of RAM U-Boot image	*/
