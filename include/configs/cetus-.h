...
#define PTN_ROOTFS_SIZE             (64 * 0x100000)
#define PTN_EBOOK_SIZE           	(320* 0x100000)
#define PTN_QTE_SIZE           		(80 * 0x100000)
#define PTN_USERDATA_SIZE           (1200 * 0x100000)
...
#define PTN_EBOOK_OFFSET           	 (76* 0x100000)
#define PTN_QTE_OFFSET           	 (396 * 0x100000)
#define PTN_USERDATA_OFFSET          (476 * 0x100000)
