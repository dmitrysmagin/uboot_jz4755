...
320e_dualboot_config	:	unconfig
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_DUALBOOT" >> $(obj)include/config.h
	@echo "Compile NAND boot image for 320e"
	@./mkconfig -a 320e mips mips 320e
	@echo "TEXT_BASE = 0x80100000" > $(obj)board/320e/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk

320e_mbr_config	:	unconfig
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_MSC_U_BOOT"  > $(obj)include/config.h
	@echo "Compile NAND boot image for 320e"
	@./mkconfig -a 320e mips mips 320e
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/320e/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_MBR_UBOOT = y" >> $(obj)include/config.mk
